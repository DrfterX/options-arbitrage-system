...
DEFAULT_SYMBOLS = [
    ...
    ("SP", "纸浆", "纸浆期权", "SHFE", "能化", 10, 1, 0),
    ("BR", "合成橡胶", "合成橡胶期权", "SHFE", "能化", 5, 1, 0),
    ("SS", "不锈钢", "不锈钢期权", "SHFE", "金属", 5, 1, 0),
    ("AO", "氧化铝", "氧化铝期权", "SHFE", "金属", 20, 1, 0),

    # ─── 上海国际能源交易中心 (INE) ───
    ("SC", "原油", "原油期权", "INE", "能化", 1000, 1, 1),
    ("LU", "LU燃油", "LU燃油期权", "INE", "能化", 10, 1, 0),
    ("NR", "20号胶", "20号胶期权", "INE", "能化", 10, 1, 0),

    # ─── 大连商品交易所 (DCE) ───
    ("M", "豆粕", "豆粕期权", "DCE", "油脂", 10, 1, 1),
    ("C", "玉米", "玉米期权", "DCE", "农副", 10, 1, 0),
    ("CS", "玉米淀粉", "玉米淀粉期权", "DCE", "农副", 10, 1, 0),
    ("Y", "豆油", "豆油期权", "DCE", "油脂", 10, 1, 1),
    ("P", "棕榈油", "棕榈油期权", "DCE", "油脂", 10, 1, 1),
    ("I", "铁矿石", "铁矿石期权", "DCE", "黑色", 100, 1, 1),
    ("J", "焦炭", "焦炭期权", "DCE", "黑色", 100, 1, 0),
    ("JM", "焦煤", "焦煤期权", "DCE", "黑色", 60, 1, 0),
    ...
    ("A", "豆一", "豆一期权", "DCE", "油脂", 10, 1, 0),
    ("B", "豆二", "豆二期权", "DCE", "油脂", 10, 1, 0),
    ...
    ("FG", "玻璃", "玻璃期权", "CZCE", "能化", 20, 1, 0),
    ("SA", "纯碱", "纯碱期权", "CZCE", "能化", 20, 1, 0),
    ("UR", "尿素", "尿素期权", "CZCE", "能化", 20, 1, 0),
    ("SH", "烧碱", "烧碱期权", "CZCE", "能化", 30, 1, 0),
    ("SF", "硅铁", "硅铁期权", "CZCE", "黑色", 5, 1, 0),
    ("SM", "锰硅", "锰硅期权", "CZCE", "黑色", 5, 1, 0),
    ("PK", "花生", "花生期权", "CZCE", "农副", 5, 1, 0),
    ("CJ", "红枣", "红枣期权", "CZCE", "农副", 5, 1, 0),
    ("PF", "短纤", "短纤期权", "CZCE", "能化", 5, 1, 0),
    ("PX", "对二甲苯", "对二甲苯期权", "CZCE", "能化", 5, 1, 0),
    ("PR", "瓶片", "瓶片期权", "CZCE", "能化", 5, 1, 0),
